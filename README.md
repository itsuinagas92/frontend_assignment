...
* Installed dotenv - dotenv simplifies the process of managing environment variables, making it easier to keep sensitive information separate from your codebase and allowing you to configure your application easily for different environments (development, staging, production, etc.) without modifying the code.

* Added .env file to store variables

* Run command npm install or npm i

* Used React Frame work to do this task
